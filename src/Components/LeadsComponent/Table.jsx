...
const TableComponent = ({ data, columns, selectColumns, selectOptions }) => {
  ...
  const handleCreationUpdateDateFilterChange = (event, newValue) => {
    if (newValue) {
      setFilterCreationUpdateDate(newValue);
      console.log(filterCreationUpdateDate);
    } else {
      setFilterCreationUpdateDate("");
      console.log(filterCreationUpdateDate);
    }
  };
      ...
      <TableContainer component={Paper}>
        <Box display={"flex"} flexDirection={"row"}>
          {/* <Autocomplete
            ...
            size="small"
            value={filterCreationUpdateDate}
            onChange={handleCreationUpdateDateFilterChange}
            options={selectOptions["Creation/Update Date"]}
            renderInput={(params) => (
              <TextField {...params} label={"Creation/Update Date"} />
            )}
          /> */}
